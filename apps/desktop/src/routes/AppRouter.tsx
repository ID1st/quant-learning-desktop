...
const ApiConfigPage = lazy(() =>
  import("../pages/ApiConfigPage").then((module) => ({ default: module.ApiConfigPage })),
);
const ChartWorkspacePage = lazy(() =>
  import("../pages/ChartWorkspacePage").then((module) => ({ default: module.ChartWorkspacePage })),
);
...
const StrategyManagementPage = lazy(() =>
  import("../pages/StrategyManagementPage").then((module) => ({
    default: module.StrategyManagementPage,
  })),
);
const StrategyLearningPage = lazy(() =>
  import("../pages/StrategyLearningPage").then((module) => ({
    default: module.StrategyLearningPage,
  })),
);
