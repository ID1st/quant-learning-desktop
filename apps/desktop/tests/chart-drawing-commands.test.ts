...
import { createChartDrawingCommandState, executeChartDrawingCommand, redoChartDrawingCommand, undoChartDrawingCommand } from "../src/features/chartDrawings/chartDrawingCommands.ts";

const drawing = { id: "line-1", type: "horizontal-line" as const, visible: true, createdAt: "2026-07-12T00:00:00.000Z", price: 100, label: "参考线" };
...
test("drawing commands support add update delete with undo and redo", () => {
  ...
  state = executeChartDrawingCommand(state, { type: "update", drawingId: drawing.id, drawing: { ...drawing, price: 120 } });
